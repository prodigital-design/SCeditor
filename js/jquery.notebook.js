...
(function($, d, w) {
    var transform = (function() {
        ...
        utils = {
            ...
            html: {
                ...
                //making a function addTag to edit the further tags using contenteditable property.
        ...
        bubble = {
            ...
            // positioning the bubble above the selection.
            ...
            // updating the bubble to set the active formats for the current selection.
            ...
            checkForFormatting: function(currentNode, formats) {
                var validFormats = ['b', 'i', 'u', 'a', 'foreColor'];
        ...
        events = {
            commands: {
                ...
                foreColor: function(e) {
                    e.preventDefault();
                    d.execCommand('foreColor', false, 'red');
                    bubble.update.call(this);
                    events.change.call(this);
                },
                anchor: function(e) {
    ...
    $.fn.notebook.defaults = {
        ...
        mode: 'multiline',
        modifiers: ['bold', 'underline', 'foreColor', 'anchor']
    };
...
function printLinks(){
    ...
    for(var i = 0; i < saved_links.length; i++) {
        if(i&1){
            text += "<li style = 'color:blue'>" + saved_links[i]+ "</li>";
        }
        else{
            text += "<li style = 'color:red'>" + saved_links[i]+ "</li>";
        }
    }
    text += "</ul>";
